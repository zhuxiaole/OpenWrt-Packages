...
git_sparse_clone openwrt-21.02 "https://github.com/immortalwrt/luci" "21openwrt" applications/luci-app-frpc
...
svn co https://github.com/coolsnowwolf/luci/trunk/applications/luci-app-ramfree
